...
PokerdiceFrame:SetSize(200, 545)
...
-- Bouton plus (règles), casé tout en haut pour laisser la place au texte de statut en dessous
local PlusButton = CreateFrame("Button", nil, PokerdiceFrame, "GameMenuButtonTemplate")
PlusButton:SetPoint("TOP", PokerdiceFrame, "TOP", 20, -8)
...
foldButton:SetSize(70, 30)
foldButton:SetPoint("RIGHT", bidButton, "LEFT", -4, 0)
