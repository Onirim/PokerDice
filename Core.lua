...
statusText:SetPoint("TOP", PokerdiceFrame, "TOP", 0, -34)
statusText:SetWidth(170)
...
-- Bouton pour se coucher lors de la seconde mise
foldButton = CreateFrame("Button", nil, goldFrame, "GameMenuButtonTemplate")
foldButton:SetSize(80, 30)
foldButton:SetPoint("LEFT", goldFrame, "RIGHT", -80, 10)
